...
The equation of the neural network is decomposed into several layers of neurons.
...
I have already told about tensorflow. Tensorflow is not a ML library. It is a mathematical library. It self-describes itself as an  _open source software library for numerical computation using data flow graphs. Nodes in the graph represent mathematical operations, while the graph edges represent the multidimensional data arrays (tensors) communicated between them._
...
Even better, the models generated by tensorflow can be saved once learned and transfered to another device. For example, you can train your models on very powerfull machines and simply copy the result to your client (for example a phone). 
